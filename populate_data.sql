-- 1. Reset and Create website_data table
DROP TABLE IF EXISTS public.website_data CASCADE;
...
-- 2. Insert the actual website data
INSERT INTO public.website_data (id, content) VALUES (1, '{
  ...
  "brands": {
    ...
    "items": [
      ...
      {
        "name": "S. Kumar Solar",
        "location": "Renewable Energy Solutions",
        "image": "assets/images/new_photos/IMG_2261.JPG.jpeg"
      }
    ]
  },
  "facilities": {
    ...
    "items": [
      {
        ...
        "text": "Dive into excitement at our state-of-the-art water park! Featuring massive slides, a crystal-clear swimming pool, and a high-energy Rain Dance area, it''s the perfect way to beat the heat and create unforgettable family memories.",
        "image": "assets/images/new_photos/IMG_3212.JPG.jpeg"
      },
      {
        "id": "fac2",
        "title": "Deluxe Resort Rooms",
        "text": "Relax in our highly comfortable, air-conditioned rooms designed for ultimate relaxation. Each room is equipped with modern amenities, premium bedding, and a peaceful ambiance to recharge after a fun-filled day.",
        "image": "assets/images/new_photos/IMG_3213.JPG.jpeg"
      },
      {
        "id": "fac3",
        "title": "Sports & Indoor Games",
        "text": "Challenge your friends to a game of cricket or football on our massive open grounds, or stay cool indoors with snooker, billiards, carom, chess, and more in our dedicated indoor sports zone.",
        "image": "assets/images/new_photos/IMG_3467.JPG.jpeg"
      }
    ]
  },
  "dining": {
...
-- 3. Set up security for website_data
...
-- 4. Reset and Create enquiries table
...
-- 5. Set up security for enquiries
ALTER TABLE public.enquiries ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Public Insert Access" ON public.enquiries FOR INSERT WITH CHECK ( true );
